...
namespace LE
{
	...
	void ImGuiLayer::OnUpdate()
    {
        ...
        io.DeltaTime = m_Time > 0.f ? (deltaTime - m_Time) : (1.f / 60.f);
        m_Time = deltaTime;
	...
	void ImGuiLayer::OnEvent(Event& e)
	{
        ...
        dispatcher.Dispatch<MouseButtonPressedEvent>(LE_BIND(this, &ImGuiLayer::OnMouseButtonPressedEvent));
        dispatcher.Dispatch<MouseButtonReleasedEvent>(LE_BIND(this, &ImGuiLayer::OnMouseButtonReleasedEvent));
        dispatcher.Dispatch<MouseMovedEvent>(LE_BIND(this, &ImGuiLayer::OnMouseMovedEvent));
        dispatcher.Dispatch<MouseScrolledEvent>(LE_BIND(this, &ImGuiLayer::OnMouseScrolledEvent));

        dispatcher.Dispatch<KeyPressedEvent>(LE_BIND(this, &ImGuiLayer::OnKeyPressedEvent));
        dispatcher.Dispatch<KeyReleasedEvent>(LE_BIND(this, &ImGuiLayer::OnKeyReleasedEvent));
        dispatcher.Dispatch<KeyTypedEvent>(LE_BIND(this, &ImGuiLayer::OnKeyTypedEvent));
    ...
    bool ImGuiLayer::OnKeyPressedEvent(KeyPressedEvent& e)
    {
        ...
        const ImGuiKey imguiKey = (ImGuiKey)KeyToImGuiKey(e.GetKeyCode(), e.GetScancode());
        io.AddKeyEvent(imguiKey, true);
        io.SetKeyEventNativeData(imguiKey, e.GetKeyCode(), e.GetScancode());
